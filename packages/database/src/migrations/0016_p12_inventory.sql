-- P12 — Inventory, Recipes & Purchasing (docs/prd/12-inventory-recipes-purchasing.md).
-- Tables: suppliers, inventory_items, stock_locations, stock_levels, stock_movements,
...
CREATE INDEX "wastage_events_item_id_idx" ON "wastage_events" USING btree ("inventory_item_id");--> statement-breakpoint
...
CREATE POLICY suppliers_tenant_isolation ON "suppliers" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY inventory_items_tenant_isolation ON "inventory_items" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY stock_locations_tenant_isolation ON "stock_locations" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY stock_levels_tenant_isolation ON "stock_levels" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY stock_movements_tenant_isolation ON "stock_movements" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY purchase_orders_tenant_isolation ON "purchase_orders" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY purchase_order_items_tenant_isolation ON "purchase_order_items" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY goods_receipts_tenant_isolation ON "goods_receipts" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY stock_counts_tenant_isolation ON "stock_counts" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY stock_adjustments_tenant_isolation ON "stock_adjustments" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY recipes_tenant_isolation ON "recipes" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY recipe_ingredients_tenant_isolation ON "recipe_ingredients" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());--> statement-breakpoint
...
CREATE POLICY wastage_events_tenant_isolation ON "wastage_events" FOR ALL USING ("organization_id" = app_current_organization_id()) WITH CHECK ("organization_id" = app_current_organization_id());
--> statement-breakpoint
-- Add reconciled_at column to payments for P7 reconciliation feature.
ALTER TABLE "payments" ADD COLUMN "reconciled_at" timestamp with time zone;
--> statement-breakpoint
-- Add tax registration columns to organizations for P9 KRA compliance.
ALTER TABLE "organizations" ADD COLUMN "tax_id" text;
--> statement-breakpoint
ALTER TABLE "organizations" ADD COLUMN "tax_serial" text;
